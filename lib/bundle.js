...
/***/ function(module, exports, __webpack_require__) {
	...
	const ZAPDOS = {
	    ...
	    spriteWidth: 73,
	    spriteHeight: 78,
	    x: Math.floor(Math.random() * (100 - 45 + 1) + 45),
	    y: Math.floor(Math.random() * (4 - 0 + 1) + 1)
	};
	...
	// for (let i = 0; i < 3; i++) {
	//   new Pokemon(ZAPDOS.world, ZAPDOS.name, ZAPDOS.image, ZAPDOS.spriteWidth, ZAPDOS.spriteHeight, Math.random() * (100 - 45 + 1) + 45, Math.random() * (4 - 0 + 1) + 1)
	// }
	...
	let zapdos1 = new Pokemon(world, ZAPDOS.name, ZAPDOS.image, ZAPDOS.spriteWidth, ZAPDOS.spriteHeight, Math.random() * (100 - 45 + 1) + 45, Math.random() * (4 - 0 + 1) + 1, 5, -90);
	
	let zapdos2 = new Pokemon(world, ZAPDOS.name, ZAPDOS.image, ZAPDOS.spriteWidth, ZAPDOS.spriteHeight, Math.random() * (100 - 45 + 1) + 45, Math.random() * (4 - 0 + 1) + 1, 5, -90);
	
	let zapdos3 = new Pokemon(world, ZAPDOS.name, ZAPDOS.image, ZAPDOS.spriteWidth, ZAPDOS.spriteHeight, Math.random() * (100 - 45 + 1) + 45, Math.random() * (4 - 0 + 1) + 1, 5, -90);
